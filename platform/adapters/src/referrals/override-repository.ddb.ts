 ...
 *
 * DDD: Infrastructure adapter implementing Override repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { OverrideRepository } from "@lendora/services/referrals";
...
/**
 * OverrideRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: OVERRIDE
 * Entity Token: OVERRIDE
 * SK Prefix: OVERRIDE
 */
export class OverrideRepositoryDdb implements OverrideRepository {
  ...
  private readonly ENTITY_TYPE = "OVERRIDE";
  private readonly ENTITY_TOKEN = "OVERRIDE";
  private readonly SK_PREFIX = "OVERRIDE";
  ...
  private readonly ENTITY_TYPE_PK = "OVERRIDES";
