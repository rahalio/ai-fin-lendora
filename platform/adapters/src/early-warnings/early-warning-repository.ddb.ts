/**
 * EarlyWarningRepository - DynamoDB Implementation
 *
...
/**
 * EarlyWarningRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing EarlyWarning repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { EarlyWarningRepository } from "@lendora/services/early-warnings";
...
/**
 * EarlyWarningRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: EARLY_WARNING_ALERT
 * Entity Token: EARLY_WARNING_ALERT
 * SK Prefix: EARLY_WARNING_ALERT
 */
export class EarlyWarningRepositoryDdb implements EarlyWarningRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "EARLY_WARNING_ALERT";
  private readonly ENTITY_TOKEN = "EARLY_WARNING_ALERT";
  private readonly SK_PREFIX = "EARLY_WARNING_ALERT";
  ...
  private readonly DOMAIN = "EARLY_WARNINGS";
  private readonly ENTITY_TYPE_PK = "EARLY_WARNING_ALERTS";
  private generateCorrelationId(): string {
    const domainPrefix = "ews";
