/**
 * EarlyWarnings API Types
 *
 * API contract types come from @lendora/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @lendora/core)
// ============================================================================
...
export type {
  // Add types from @lendora/core/early-warnings
} from "@lendora/core";

// Re-export with alias for backward compatibility if needed
// export type CoreEarlyWarningsItem = EarlyWarningsItem;
