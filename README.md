...
Automated credit-decisioning for banks and NBFCs: policy overlays, accept/refer/decline, refer queues, early-warning, and governed model learning.
...
# Demo key: X-API-Key: lendora_demo_local_dev_key
```
...
```bash
docker compose up -d
TABLE_NAME=lendora-core-local AWS_ENDPOINT_URL=http://localhost:8000 node scripts/ensure-dynamo-table.mjs
```
